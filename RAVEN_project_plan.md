...
*文件最後更新：2026-06-17*
*專案狀態：M1 完成 ✅；M2 進行中（規則引擎 + 重構已完成，剩餘：SQLi/cmd/eval 規則、JS 支援、rich 彩色輸出）*
